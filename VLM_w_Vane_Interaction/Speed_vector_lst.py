...
#-----------------------------------------------
#Speed vectors of Vane 2
v_vec_vane2=[]
for l in range(len(v_lst)):
    v_vec_vane1.append(np.array([v_lst_ax[l],0,-v_lst[l]]))

#-----------------------------------------------
#Speed vectors of Vane 3
v_vec_vane3=[]
for l in range(len(v_lst)):
    v_vec_vane1.append(np.array([v_lst_ax[l],-v_lst[l],0]))

#-----------------------------------------------
#Speed vectors of Vane 4
v_vec_vane4=[]
for l in range(len(v_lst)):
    v_vec_vane1.append(np.array([v_lst_ax[l],v_lst[l],0]))

v_vec_total=v_vec_vane1+v_vec_vane2+v_vec_vane3+v_vec_vane4
